...
try {
    // Check if login_history table exists (PostgreSQL compatible)
    $tableCheck = $pdo->query("SELECT EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'login_history')");
